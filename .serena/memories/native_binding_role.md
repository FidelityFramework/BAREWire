...
```
Farscape (generates) → BAREWire.[Target] (descriptors) → Firefly/Alex (consumes)
```

BAREWire.Core provides abstract types. BAREWire.[Target] modules (generated by Farscape) contain concrete hardware descriptions.
